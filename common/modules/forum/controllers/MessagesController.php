...
use common\modules\forum\models\Message;
use common\modules\forum\models\MessageReceiver;
use common\modules\forum\models\MessageSearch;
...
class MessagesController extends BaseController
{
    ...
    public function actions()
    {
        return [
            'delete-received' => [
                'class' => 'common\modules\forum\actions\MessageAction',
