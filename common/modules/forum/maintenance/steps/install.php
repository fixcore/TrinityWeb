    ...
    [
        ...
        'data' => [
            'schema' => [
                ...
                'create_thread' => Schema::TYPE_SMALLINT . ' NOT NULL DEFAULT 1',
    ...
    [
        ...
        'data' => [
            'schema' => [
                ...
                'lvl' => Schema::TYPE_SMALLINT . ' NOT NULL DEFAULT 0',
                'icon' => Schema::TYPE_STRING,
                'icon_type' => Schema::TYPE_SMALLINT . ' DEFAULT 1',
                'active' => Schema::TYPE_BOOLEAN . ' DEFAULT 1',
                'disabled' => Schema::TYPE_BOOLEAN . ' DEFAULT 0',
                'selected' => Schema::TYPE_BOOLEAN . ' DEFAULT 0',
                'readonly' => Schema::TYPE_BOOLEAN . ' DEFAULT 0',
                'collapsed' => Schema::TYPE_BOOLEAN . ' DEFAULT 0',
                'movable_d' => Schema::TYPE_BOOLEAN . ' DEFAULT 0',
                'movable_u' => Schema::TYPE_BOOLEAN . ' DEFAULT 0',
                'movable_l' => Schema::TYPE_BOOLEAN . ' DEFAULT 0',
                'movable_r' => Schema::TYPE_BOOLEAN . ' DEFAULT 0',
                'removable' => Schema::TYPE_BOOLEAN . ' DEFAULT 1',
                'removable_all' => Schema::TYPE_BOOLEAN . ' DEFAULT 0',
